...
def get_intake_attrs(ds: xr.Dataset, prefix: str = "cat:") -> dict:
    """
    Retrieves the global attributes generated by intake-esm and compiles them in a dictionary.
    ...
    prefix: str
        Prefix automatically generated by intake-esm. With scen, this should be 'cat:'
    ...
    info = {
        attr.replace(f"{prefix}", ""): ds.attrs[attr]
