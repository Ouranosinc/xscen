...
#     with  set_options(check_missing="wmo"):
...
# def test_indicator_call_errors(timeseries):
#     tas = timeseries(np.arange(730), start="2001-01-01", units="K")
